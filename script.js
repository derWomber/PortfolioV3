...
if (Width < 801) {
  document.getElementById("pOn").textContent =
    "Entwickler, HTML/CSS/JS/Python, sucht Ausbildung als Fachinformatiker Anwendungsentwicklung.";
}
...
audioPlayer.addEventListener("click", () => {
  if (audio.currentTime === 0) {
    audio.play();
    audioPlayer.style.fill = "#fff";
    audioPlayer.style.scale = 1.2;
  } else {
    audio.pause();
    audio.currentTime = 0;
    audioPlayer.style.fill = "var(--Accent)";
    audioPlayer.style.scale = 1;
  }
});
...
const translations = {
  ...
  en: {
    ...
    pOn_mobile:
      "Developer, HTML/CSS/JS/Python, seeks apprenticeship as an IT specialist in application development.",
  ...
  fr: {
    ...
    pOn_mobile:
      "Développeur HTML/CSS/JS/Python, recherche un apprentissage en tant que spécialiste informatique en développement d'applications.",
...
function switchLanguage(lang) {
  ...
  document.getElementById("projects_sidebar").textHTML =
    translations[lang].projects;

  document.getElementById("education_sidebar").textHTML =
  ...
  document.getElementById("lebenslaufButton").textContent =
    translations[lang].cv;
  document.getElementById("kontactButton").textContent =
